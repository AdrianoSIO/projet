...
<div class="container my-4">
    <div class="card">
        ...
        $total = $pdo->query("SELECT COUNT(*) FROM Produit WHERE Actif = 1")->fetchColumn();
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" style="margin:0;">
                                        ...
                                        <button type="submit" name="rendre_inactif" class="btn btn-danger btn-sm"style="background-color: rgb(206, 0, 0);">Rendre inactif</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endwhile; ?>
